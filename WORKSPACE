...
load("@tf_modules//tools:toolchains.bzl", "tools_register_toolchains")

tools_register_toolchains(terraform_versions = ["0.12.23","0.12.24","1.2.2"])
...
go_repository(
    ...
    sum = "h1:Pm6R878vxWWWR+Sa3ppsLce/Zq+JNTs6aVvRu13jv9A=",
    version = "v0.0.0-20200105231215-408a2507e114",
)
...
go_repository(
    ...
    sum = "h1:YvQ10rzcqWXLlJZ3XCUoO25savxmscf4+SC+ZqiCHhA=",
    version = "v0.0.0-20200107162124-548cf772de50",
)
...
go_repository(
    ...
    sum = "h1:OOkytthzFBKHY5EfEgLUabprb0LtJVkQtNxAQ02+UE4=",
    version = "v0.0.0-20200113040837-eac381796e91",
)
